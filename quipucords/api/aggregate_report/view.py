...
@extend_schema(
    responses=inline_serializer(
        name="AggregateReportSerializer",
        fields={
            ...
            'jboss_eap_cores_physical': serializers.IntegerField(default=0, min_value=0),
            'jboss_eap_cores_virtual': serializers.IntegerField(default=0, min_value=0),
            'jboss_eap_instances': serializers.IntegerField(default=0, min_value=0),
            'jboss_ws_cores_physical': serializers.IntegerField(default=0, min_value=0),
            'jboss_ws_cores_virtual': serializers.IntegerField(default=0, min_value=0),
